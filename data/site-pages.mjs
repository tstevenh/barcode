...
export const CONTACT_EMAIL = "hello@barcodeapis.com"; // TODO: replace with the real support address
...
export const STATIC_PAGES = [
  {
    slug: "about",
    title: "About Barcode APIs",
    description: "About Barcode APIs — a fast, free online barcode and QR code generator supporting 100+ symbologies with live preview and instant export.",
    eyebrow: "About",
    h1: "About Barcode APIs",
    lead: "A fast, free barcode and QR code generator that runs right in your browser.",
    bodyHtml: `
      <h2>What it is</h2>
      <p>Barcode APIs is a free online generator for more than 100 barcode and QR code symbologies — including QR, Data Matrix, PDF417, Aztec, EAN, UPC, GS1, and Code 128. You pick a symbology, type your data, tune the appearance, and export a clean PNG or SVG in seconds. No account, no watermark, no waiting.</p>
      <h2>How it works</h2>
  ...
  {
    slug: "contact",
    title: "Contact Barcode APIs",
    description: "Get in touch with Barcode APIs — questions, bug reports, feature requests, and Pro/API enquiries.",
    eyebrow: "Contact",
    h1: "Contact us",
  ...
  {
    slug: "privacy",
    title: "Privacy Policy — Barcode APIs",
    description: "How Barcode APIs handles your data: what we collect, the processors we use, and your choices.",
    eyebrow: "Privacy",
    h1: "Privacy Policy",
    ...
    bodyHtml: `
      ...
      <p>Barcode APIs is built to need as little of your data as possible. There are no accounts, no advertising trackers, and no analytics cookies. The only personal information we collect is what you choose to give us — for example, your email address if you join the early-access list.</p>
  ...
  {
    slug: "terms",
    title: "Terms of Service — Barcode APIs",
    description: "The terms that apply when you use Barcode APIs.",
    eyebrow: "Terms",
    h1: "Terms of Service",
    lead: "The basics of using Barcode APIs.",
    bodyHtml: `
      ${REVIEW_NOTE}
      <h2>Using the service</h2>
      <p>Barcode APIs is provided free of charge for generating barcodes and QR codes. By using it, you agree to these terms. If you don't agree, please don't use the service.</p>
      ...
      <p>To the fullest extent permitted by law, Barcode APIs is not liable for any indirect, incidental, or consequential damages arising from your use of the service or from any barcode you generate with it.</p>
      <h2>Changes</h2>
